...
```{r}
include_graphics("./geuvadis_reanalysis/replicates/plots/replicates.png")
```
...
Here we evaluate whether a pair of alleles within the same haplotypes are 
associated with eQTLs alleles in the same direction of regulation, i.e. 
upper-upper regulation, down-down, or upper-down.

```{r}
include_graphics("./geuvadis_reanalysis/eqtl_mapping/plots/correlation_of_eqtls.png")
```
