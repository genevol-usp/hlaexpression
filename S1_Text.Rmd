...
Because our study and the previously published papers with qPCR expression data involve different tissues and samples, they cannot be directly compared (e.g., using a correlation analysis). Instead, we chose to ask whether the the ordering of HLA lineages by their expression levels differs among studies.  
