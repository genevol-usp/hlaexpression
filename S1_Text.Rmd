...
We also queried whether SNPs idenfied as having a regulatory role upon qPCR-based expression studies were statistically correlated (i.e., in linkage disequilibrium) with those we identified as having the greatest effect on expression, and if these effects were indepedent. 
