...
**Table 3.** Relationship between our eQTLs and previously described regulatory SNPs  ("Reg-SNP"). r2: r-squared; AF: allele frequency; p: the backward pass p-value from QTLtools for the validated SNP (NA when SNP did not pass to the backward stage).  
