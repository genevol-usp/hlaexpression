...
gencode12 <- get_gencode_coords("~/gencode_data/gencode.v12.annotation.gtf.gz")
setDT(gencode12)

gencode12 <- gencode12[gene_name %in% hla_genes][, .(gene_id, gene_name)]

geuvadis <- 
    fread("zcat < ../../../../../data/previous_qtls/geuvadis_eur_eqtls.txt.gz")
