...
```{r}
"./qtls_kallisto/qtltools_correction/rtc/geuvadis_eqtls/results.tsv" %>%
  read_tsv() %>%
  kable()
```
...
```{r}
read_tsv("./qtls_kallisto/qtltools_correction/rtc/gwas/results.tsv") %>%
...
```{r}
read_tsv("./qtls_kallisto/qtltools_correction/trans/trans_results.tsv") %>%
  kable()
```
