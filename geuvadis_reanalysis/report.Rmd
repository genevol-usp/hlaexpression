...
```{r}
"./qtls/star/main_pipeline/supplemented/encode_TF_Seq_DNase/hla.qtl.functional.elements.tsv" %>%
    read_tsv()%>%
    kable(digits = 2)
```
...
```{r}
"./qtls/star/main_pipeline/transcriptome/encode_TF_Seq_DNase/hla.qtl.functional.elements.tsv" %>%
    read_tsv() %>%
    kable(digits = 2)
```
