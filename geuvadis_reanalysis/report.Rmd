...
```{r}
include_graphics("./qtls/plots/landscape_class1.png")
```

### Class II

```{r}
include_graphics("./qtls/plots/landscape_class2.png")
```
...
```{r}
read_tsv("./qtls/qtls_star/imgt/rtc/geuvadis_eqtls/results.tsv") %>%
    kable()
```
...
```{r}
geuvadis_qtls <- 
    read_tsv("./qtls/qtls_star/imgt/rtc/geuvadis_eqtls/catalog.tsv",
...
read_tsv("./qtls/qtls_star/imgt/rtc/previous_qtls/results.tsv") %>%
    select(-distance_eqtl_previous_gene) %>%
    kable()
```
