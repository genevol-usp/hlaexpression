...
If our eQTLs are not eQTLs in regulomeDB, are they tagging the same signal as
other eQTL in the database?

```{r}
read_tsv("./qtls/qtls_star/imgt/rtc/regulomeDB/results_affected_genes.tsv") %>%
    kable(digits = 3)
```
...
Our eQTLs tag eQTLs, cQTLs, aCRD-QTLs and sCRD-QTLs in that study. Here I show 
the RTC with cQTLs:
