...
```{r}
include_graphics("./plots/reads_lost_imgt.png")
```

### Reference transcriptome Index

```{r}
include_graphics("./plots/reads_lost_pri.png")
```
...
```{r}
include_graphics("./plots/reads_gained_imgt.png")
```

### Reference transcriptome Index

```{r}
include_graphics("./plots/reads_gained_pri.png")
```
