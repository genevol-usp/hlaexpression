...
fasta=/home/vitor/hlaexpression/imgt_index_trimmed/gencode.v25.PRI.transcripts.noIMGT.fa
...
$salmon quant -t $sample_fa -l IU -a $bam -o $out -p 8 --seqBias --gcBias

header=${outPrefix}header.sam
sampledir=$outMap/$sample
imgtbam=$sampledir/imgt.bam
bed=./sample_indices/${sample}_imgt.bed
...
$samtools depth -a -m 100000 -b $bed $imgtbam > $cov
